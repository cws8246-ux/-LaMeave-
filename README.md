...
<head>
    ...
    <title>LaMeave | French Chic Wellness Lounge</title>
    <!-- Tailwind CSS CDN 로드 -->
...
<body class="relative">
    ...
    <nav class="fixed w-full z-50 transition-all duration-300 bg-black/80 backdrop-blur-md border-b border-white/5">
        <!-- 모바일 컷오프 방지를 위해 px-4 기본 적용, sm 이상에서 px-6 -->
        <div class="max-w-7xl mx-auto px-4 sm:px-6 h-20 flex justify-between items-center">
            ...
            <div class="flex items-center space-x-4">
                ...
                <a id="navReserveBtn" 
                   ...
                   class="reaction-animation bg-[#ff5e1e] text-white text-xs font-bold px-4 py-3 sm:px-6 sm:py-3 rounded-none hover:bg-[#d14008] transition tracking-widest">
                    RESERVE
                </a>
            </div>
        </div>
    ...
    <section id="philosophy" class="relative h-screen flex items-center justify-center overflow-hidden bg-[#0f0f0f]">
        <!-- 모바일 안전성을 위해 폰트 크기 조정 및 px-4 기본 적용 -->
        <div class="relative z-10 text-center px-4 sm:px-6 max-w-5xl mx-auto animate-fade-in pt-20"> 
            ...
            <!-- 메인 타이틀: 요청에 따라 두 줄로 분리 -->
            <h1 class="font-serif text-4xl sm:text-5xl md:text-7xl lg:text-8xl text-white mb-8 leading-tight editable-text" data-field="hero_title" contenteditable="false">
                ELEVATE ME,<br><span class="text-[#dfa67b]">LA MEAVE</span>
            </h1>
            <div class="w-20 h-[1px] bg-[#dfa67b] mx-auto mb-8"></div>
            <!-- 모바일에서 text-base로 시작하여 안전하게 확장 -->
            <p class="text-gray-200 text-base sm:text-lg md:text-2xl font-light leading-relaxed mb-12 editable-text" data-field="hero_desc" contenteditable="false">
                내면(마음)과 외면(몸)의 균형을 되찾아,<br>나를 더 아름답게, 밝게, 가볍게 만드는 공간.
            </p>
        </div>
    ...
    <section class="py-24 px-4 sm:px-6 bg-[#0f0f0f]">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                <div class="text-center p-8 border border-gray-800 hover:border-[#dfa67b] transition duration-500 animate-fade-in" style="animation-delay: 0.5s;">
                    <div class="text-4xl text-[#dfa67b] mb-6 inline-block">
                        <svg class="w-8 h-8 mx-auto" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M5 3s.34.42.5.5c.24.23.44.43.7.67M22 12h-4m-7-7V2.5M10 20.5V22M20 18l-2-2M18 6l-2 2M6 18l2-2M6 6l2 2M2 12h1m18 0h1m-1 0a9 9 0 10-18 0z" />
                        </svg>
                    </div>
    ...
    <footer class="bg-black py-24 border-t border-gray-900">
        <div class="max-w-5xl mx-auto px-4 sm:px-6 text-center animate-fade-in" style="animation-delay: 0.1s;"> <!-- 애니메이션 추가 -->
